...
public class DefaultAPIConsumer {
    ...
    private void init()
    {
        ...
        List<OrderResponse> orderResponses = restTemplate.exchange(pizzaAPIURL + "?pizza=EUREKA-REST", HttpMethod.GET, null, new ParameterizedTypeReference<List<OrderResponse>>(){}).getBody();
